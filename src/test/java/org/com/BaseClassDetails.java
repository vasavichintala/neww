...
public class BaseClassDetails {
	...
	public void type(WebElement elememt, String value) {
	...
	public void excelWrite(String sheetName, String data, int row, int coloumn) throws Exception {
		File file = new File("C:\\Users\\CHINTALA VASAVI\\eclipse-workspace\\FrameWorkProject\\src\\test\\resources\\Xlshhet\\Book1.xlsx");
